...
| CORS errors | API allows all origins by default. If you still see CORS during lecture processing, the API is likely timing out or cold-starting — wake it with `curl …/api/stack/health` first. |
